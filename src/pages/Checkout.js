...
const Checkout = () => {
    ...
    const shippingInfo =[]
    // const cartTotalAmount = useSelector((state) => state.cart.getTotalSum);
        ...
        <Helmet title='Checkout'>
           ...
           <section>
            <Container>
                <Row>
                    <Col lg='8' md='6'>
                        <h6 className="mb-4 mt-5">Shipping Address</h6>
                        <form className="checkout_form mb-3" onSubmit={submitHandler}>
                            ...
                            <div className="form_group">
                                <input type="number" placeholder="Postal code number"
